...
(2, 'Mỹ Phẩm', 'my-pham'),
(3, 'Trang Điểm', 'trang-diem'),
(4, 'Dinh Dưỡng - Sức Khỏe', 'dinh-duong-suc-khoe'),
(5, 'Làm Đẹp', 'lam-dep'),
(6, 'Khuyến Mãi', ''),
(7, 'Giới Thiệu', '');
